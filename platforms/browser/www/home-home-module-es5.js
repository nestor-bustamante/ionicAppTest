  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let HomePage = class HomePage {
      ...
      getUserDetail(userid) {
        this.fb.api('/' + userid + '/?fields=id,email,name,picture,gender,friends,location', ['public_profile', 'user_friends', 'user_location', 'user_gender', 'instagram_basic', 'user_age_range', 'user_birthday']).then(res => {
      ...
      fbLogin() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          this.loading = true;
          this.fb.login(['public_profile', 'user_friends', 'user_location', 'user_gender', 'instagram_basic', 'user_age_range', 'user_birthday', 'email']).then(res => {
            ...
            firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().signInWithCredential(credential).then(info => {
              /* tslint:disable */
      ...
      login() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          ...
          yield this.google.login(params).then(response => {
      ...
      getGeolocation() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
          this.geolocation.getCurrentPosition().then(resp => {
            ...
            window.localStorage.setItem('latlang', "".concat(resp.coords.latitude, ", ").concat(resp.coords.longitude));
          ...
          watch.subscribe(data => {
            window.localStorage.setItem('latlang', "".concat(data.coords.latitude, ", ").concat(data.coords.longitude)); // console.log(data.coords.latitude);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_8__["Geolocation"], _ionic_native_facebook_ngx__WEBPACK_IMPORTED_MODULE_4__["Facebook"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["Platform"], _ionic_native_google_plus_ngx__WEBPACK_IMPORTED_MODULE_7__["GooglePlus"]])], HomePage);
    /***/
  }
}]);
